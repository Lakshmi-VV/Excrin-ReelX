...
function NewSpacePopup({
  ...
  return (
    <div>
      <div
        className="workspace-popup-overlay"
      ...
      >
        ...
        >
          ...
          {currentStep === 2 && (
            <>
              ...
              <div className="btn-skip-continue">
                <button className="btn__skip" onClick={handlePrevStep}>
                  Skip
                </button>
          ...
          <div className="popup-slider">
            <div
              className={`dot ${currentStep === 1 ? "dot-active" : ""}`}
            ></div>
            <div
              className={`dot ${currentStep === 2 ? "dot-active" : ""}`}
            ></div>
            <div
              className={`dot ${currentStep === 3 ? "dot-active" : ""}`}
            ></div>
          </div>
        </div>
      </div>
